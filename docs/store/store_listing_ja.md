...
**表示名**: 未確定。<!-- AndroidManifest.xml:30 の android:label は現在 "sngnav_app"
（scout 062-5）。掲載前に表示名の決定が必要 — ここでは仮に「SNGNav」と表記。 -->
...
- **読み上げの言語について。** 走行中 HUD と路面凍結ウォッチの読み上げは端末の言語設定に従います（日本語／英語）。ただし「路面状態の説明」の読み上げは運転者プロファイルに紐づいており、外国人観光客プロファイルを選んだ場合は英語で読み上げます。
  <!-- BETA_PLAN.md:219-224 W3 修正（本チェンジセットで着地）を前提とした記述。
