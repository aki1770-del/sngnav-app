...
/// Extracted: the kanji name and the position of each station the table
/// fetches, degrees and minutes converted to decimal degrees, plus 32466, so
/// the old id fails on the place it really is. It is a copy: if JMA renumbers
/// or moves a station, this test fails, and that is the right answer.
library;

import 'package:flutter_test/flutter_test.dart';
import 'package:sngnav_app/jma_fetch.dart';

const _jmaStations = <String, ({String kjName, double lat, double lon})>{
  '32286': (kjName: '男鹿', lat: 39.912, lon: 139.900),
  '32402': (kjName: '秋田', lat: 39.717, lon: 140.098),
  '32466': (kjName: '角館', lat: 39.603, lon: 140.557),
  '32551': (kjName: '大曲', lat: 39.490, lon: 140.495),
  '32596': (kjName: '横手', lat: 39.320, lon: 140.555),
  '32691': (kjName: '湯沢', lat: 39.187, lon: 140.463),
};
